    ...
    <main className="container">
      ...
      >
        ...
        {tests.map((test) => (
          ...
          >
            ...
            <p>
              <strong>Value:</strong> {test.value}
            </p>
            <p>
              <strong>Active:</strong> {test.isActive ? "Yes" : "No"}
            </p>
            <p>
              <small>
      ...
      >
        ...
        <ol>
          ...
          <li>
            Run <code>npm run db:push</code> to create the database schema
          </li>
          <li>
            Run <code>npm run db:seed</code> to populate test data
          </li>
